...
import {Form, FormGroup, FormControl, ControlLabel, FlexboxGrid, Alert} from 'rsuite';
                        ...
                        <Form>
                            <FormGroup>
                                ...
                                <select id="major" name="major">
                                    ...
                                    <option value="chemistry_biochemistry">Chemistry and Biochemistry</option>
                                    <option value="chinese_studies">Chinese Studies</option>
                                    <option value="classical_studies">Classical Studies</option>
                                    <option value="cognitive_science">Cognitive Science (B.A./B.S.)</option>
                                    <option value="communication">Communication</option>
                                    <option value="cse">Computer Science and Engineering (CSE)</option>
                                    <option value="critical_gender_studies">Critical Gender Studies</option>
                                    ...
                                    <option value="environmental_systems_program">Environmental Systems Program</option>
                                    ...
                                    <option value="global_south_studies">Global South Studies</option>
                                    <option value="history">History</option>
                                    <option value="human_developmental_sciences">Human Developmental Sciences</option>
                                    <option value="international_studies">International Studies (B.A.)</option>
                                    ...
                                    <option value="latin_american_studies">Latin American Studies</option>
                                    <option value="linguistics">Linguistics</option>
                                    <option value="literature">Literature</option>
                                    <option value="marine_biology">Marine Biology</option>
                                    <option value="mathematics">Mathematics</option>
                                    <option value="mae">Mechanical and Aerospace Engineering (MAE)</option>
                                    <option value="nano_engineering">Nano Engineering</option>
                                    <option value="oas">Oceanic and Atmospheric Sciences</option>
                                ...
                                <TagPicker data={options} groupBy="department" defaultValue={options} style={{ width: 300 }} />
                                </div>
                                ...
                                <input type="radio" value="She" name="gender" /> She/Her <br/>
                                <input type="radio" value="They" name="gender" /> They/Them <br/>
